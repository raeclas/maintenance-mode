...
:root{
  ...
  /* Canvas damage skin. Documented in DESIGN.md since the visual pass and
     never actually shipped into a stylesheet — battle.js had them hardcoded,
     so tokenising the floaters against names that did not exist rendered every
     damage number, crit and the BREACHED reveal in the #000 fallback. */
  --gold-bright:#ffd700;
  --crit-gold:#ffd54a;
  --super-crit:#ff9a3c;
  --dmg-text:#e8dcc0;
