...
| Dungeon / instances (POC 2026-07-25) | the wall is never HP — a run ends when a MECHANIC goes unanswered. Nouns: instance · floor · duty (interrupt/dispel/adds) · mechanic (Sunder · Mass Dispel · Summon Adds) · key (chosen difficulty, never depletes) · haul · bank · wipe · journal (permanent knowledge; a wipe is how you learn). Bots sent in are SPENT (attrition), so depth = accounts you'll burn. Mitigation is botter-register: proxy rotation · spoofed hardware IDs |
...
| skill book (2026-07-27, skills.js) | Skills · learn · rank · pip (active charge, bank of 5) · Energy (hit-built bank, Energy Burst only) |
| passives (proc skills) | Power Strike · Double Strike · Judgment · Frenzy · Finishing Blow · Combo Attack · Battle Trance · Meteor · Chaos Strike |
| actives (cast skills) | Rage · Might · Power Smash · Focus · Blade Dance · Empower · Wild Swing · Energy Burst · Second Wind |
