...
export const bosses = [
  {
    ...
    hp: 280_000_000_000_000, // v11 drain model: an HP pool whittled at Combat Power. ~12h to break on the sim CP-curve; arrival TTK reads "overwhelming" then cascades down as you scale. ×83'd 2026-07-27 when the skill book shipped; ×11.2'd same day when gear landmarks shipped (milestone bundles collapsed W1 to 7.3h; W2–W10 rescaled by the same factor) — HP is the sanctioned compensating lever (ROADMAP hard-won rules)
  ...
  },
  {
    ...
    hp: 67_000_000_000_000_000, // v11 drain — deeper wardens stretch far longer; playtest-tune
    windowS: 30,
  ...
  // outlived its players; behind the last is the end itself.
  {
    ...
    hp: 670_000_000_000_000_000, windowS: 30, speedKnee: 13.0,
  ...
  },
  {
    ...
    hp: 5_600_000_000_000_000_000, windowS: 30, speedKnee: 18.0,
  ...
  },
  {
    ...
    hp: 50_000_000_000_000_000_000, windowS: 30, speedKnee: 24.0,
  ...
  },
  {
    ...
    hp: 450_000_000_000_000_000_000, windowS: 30, speedKnee: 31.0,
  ...
  },
  {
    ...
    hp: 4_300_000_000_000_000_000_000, windowS: 30, speedKnee: 39.0,
  ...
  },
  {
    ...
    hp: 37_000_000_000_000_000_000_000, windowS: 30, speedKnee: 48.0,
  ...
  },
  {
    ...
    hp: 340_000_000_000_000_000_000_000, windowS: 30, speedKnee: 58.0,
  ...
  },
  {
    ...
    hp: 2_800_000_000_000_000_000_000_000, windowS: 30, speedKnee: 70.0,
