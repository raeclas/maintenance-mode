...
export const bosses = [
  {
    ...
    trophy: { name: "Vess's Hinge-Key", lane: "atk", pct: 15, flavor: "The key she never used. It opens nothing now." },
    dialogue: {
      greet: [
  ...
  },
  {
    ...
    trophy: { name: "Maren's Seal", lane: "speed", pct: 15, flavor: "Broken open. The wax is still warm." },
    dialogue: {
      greet: [
